...
library WebAuthn {
    ...
    function verify(bytes memory challenge, bool requireUV, WebAuthnAuth memory webAuthnAuth, bytes32 x, bytes32 y)
        internal
        view
        returns (bool)
    {
        ...
        return P256.verify(messageHash, webAuthnAuth.r, webAuthnAuth.s, x, y);
    }
}